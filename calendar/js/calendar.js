$(document).ready(function(t, e, i) {
    ...
    $("#calendar").fullCalendar({
        ...
        events: [{
            ...
            title: "Breakfast",
            start: new Date(r, n, i, 8,40),
			end: new Date(r, n, i, 10,0),
            allDay: !1,
            className: "bg-red"
        }, {
            title: "Lunch",
            start: new Date(r, n, i, 12,30),
            end: new Date(r, n, i, 14,0),
            allDay: !1,
            className: "bg-navy"
        },{
            title: "Dinner",
            start: new Date(r, n, i, 17, 30),
            end: new Date(r, n, i, 19,0),            
            allDay: !1,
            className: "bg-purple"
        },{
            title: "Birthday Party",
            start: new Date(r, n, 15, 19, 0),
            end: new Date(r, n, 15, 22, 30),
            allDay: !1,
            className: "bg-green"
        }, {
            title: "Click for My Blog",
            start: new Date(r, n, 28),
            end: new Date(r, n, 29),
            url: "https://matthew84.gq/",
            className: "bg-lime"
        }],
        editable: !0,
        selectable: !0,
